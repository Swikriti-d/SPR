...
<section className="container mx-auto px-3 py-18">
    ...
    <div className="grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8 max-w-[660px] ">
            ...
            <div className="space-y-6">
                <div className="flex gap-6 items-start">
                    <div className="p-1 flex items-center justify-center rounded-full bg-white shadow-md">
        ...
        {/* RIGHT SIDE */}
        <div className="flex gap-3 md:gap-4  h-[360px] sm:h-[500px]">
            ...
            <div className="flex flex-col gap-4 flex-[1]">
                ...
                <div className="bg-[var(--badge-2)] px-4 py-3 flex flex-col justify-center flex-[1]">
                    <h3 className="text-2xl font-bold text-[var(--badge-text)]">09</h3>
                    <p className="text-[var(--badge-text)] text-sm">Districts Unified</p>
                </div>
            ...
            <div className="flex flex-col gap-4 flex-[1]">
                ...
                <div className="bg-[var(--badge-1)] p-4 flex items-center justify-center flex-[1]">
