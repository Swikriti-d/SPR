    ...
    <div className="flex flex-col gap-10 md:flex-row">
        ...
        <div className="flex-1 flex gap-4">
            ...
            <div className="flex flex-col gap-4 flex-1">
                ...
                <div
                    className="flex-1 bg-[var(--badge-2)] flex flex-col items-start justify-center px-4 py-2">
            ...
            {/* RIGHT COLUMN */}
            <div className="flex flex-col gap-4 flex-1">
                <div className="bg-[var(--badge-1)] px-4 py-2 flex items-center justify-center flex-1">
